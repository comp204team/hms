        ...
        return (
            <div style={{width: "1500px", alignContent: "center"}}>
                ...
                <div className="row" style={{textAlign: "center", marginLeft: "4px",}}>
                    <button className="btn btn-secondary" style={{textAlign: "center", marginLeft: "4px"}}
                            onClick={this.mainScreen}> Main
                    </button>
                    <button className="btn btn-primary" style={{textAlign: "center", marginLeft: "4px"}}
                            onClick={this.addReport}> Add Report
                    </button>
                    <button className="btn btn-primary" style={{textAlign: "center", marginLeft: "4px"}}
                            onClick={this.addDoctor}> Add Doctor
                    </button>
                    <div></div>
                    <button className="btn btn-primary " style={{textAlign: "center", marginLeft: "4px"}}
                    ...
                    <br/><br/>
                    <input type="text" placeholder="Search" style={{textAlign: "center", marginLeft: "4px"}}
                           value={this.state.searchTerm} onChange={this.changeSearchValuelHandler}/>
                    <button className="btn btn-primary" style={{textAlign: "center", marginLeft: "4px"}}
                            onClick={() => this.findInApi(this.state.searchTerm)}>
                        Search
                    </button>

                    <button className="btn btn-danger" style={{textAlign: "center", marginLeft: "4px"}}
                            onClick={this.returnBack}>Back
                    </button>
